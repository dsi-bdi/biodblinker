from biolink import KEGGLinker, GeneNameLinker
...
gene_uniprots = gene_name_db.convert_gene_name_to_uniprot(gene_names_list)
gene_uniprots = [d.split(";")[0] for d in gene_uniprots]
